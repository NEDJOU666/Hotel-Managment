...
const Card = ({icon,amount,percent,name,diff}:any) => {
  return (
      <div className="!w-[24%] hover:scale-[1.05] duration-500 cursor-pointer h-[150px] flex flex-col px-5 justify-center   shadow-md shadow-gray-300 rounded-xl bg-white">
